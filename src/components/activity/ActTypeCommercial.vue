      ...
      <el-dialog title="创建活动" :visible.sync="newActiveVisible">
        <el-form ref="newActiveform" :model="newActiveform" label-width="80px">
          ...
          <el-form-item label="活动描述">
            <el-input v-model="newActiveform.describe"></el-input>
          </el-form-item>
          <el-form-item>
...
<script type='text/ecmascript-6'>
  ...
  import setMerchantForm from './setMerchantPrize.vue';
  export default {
    data() {
      return {
        checkList: {
        ...
        //   regAward: '2元优惠券',
        //   realAward: '2元优惠券',
        //   payAward: '很长很长很长很长很长很长',
        //   FrentAward: '很长很长很长很长很长很长很',
        //   infoDate: '2018-8-14 00:00:00',
        //   loseDate: '2018-8-14 00:00:00',
        //   isOpen: true,
        //   createID: 'admin'
        // },
        //   {
    ...
    methods: {
      ...
      alActive () {
        let post = {
          ...
          discription: this.newActiveform.describe,
      ...
      find () {
        ...
        this.util.SendAjax(this, post, 'activityCrmApi/getActivity.do').then((res) => {
          ...
          for (let i = 0; i < res.data.length; i++) {
            ...
            obj.describe = res.data[i].discription;
      ...
      handleCommand (com) {
        switch (com[0]) {
          ...
          //   break;
          case 5:
            this.$refs.setMerchantForm.getDetail(com[1].row.ID);
